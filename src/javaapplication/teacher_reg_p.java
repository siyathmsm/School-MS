 ...
 * @author SIYATH MSM
 */
public class teacher_reg_p extends javax.swing.JFrame {

    /** Creates new form student_reg */
    public teacher_reg_p() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        registration_p i = new registration_p();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(teacher_reg_p.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new teacher_reg_p().setVisible(true);
            }
        });
    }
